...
subtitle: "Overview of python application I created to aid productivity and reduce learning curve to working at the Tech Desk at the University of St. Thomas"
...
format: 
  html: 
    code-links:
      - text: Repository
        href: https://github.com/JonathanmBarnes/Tech-Desk-Tools-Python
        icon: github
editor: visual
...
geometry:
  ...
  - top=.5in
  - bottom=.5in
image: "PhotoDepPort/TDTHome.png"
---
